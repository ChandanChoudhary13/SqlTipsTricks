...
-- Test Block
-- SELECT  dbo.GenerateTableToModel('dbo','CustomerType','CustomerTypeDTO')
-- =============================================
CREATE FUNCTION GenerateTableToModel
(
	--------------- Input arguments ---------------
...
BEGIN
	...
	SET @ResponseText = 'public class ' + @className
	SET @ResponseText += '{'
	...
	BEGIN
		...
		SET @ResponseText += '    public ' + @typeName + ' ' + @name + ' { get; set; }'	
		FETCH NEXT FROM tableColumns INTO @name, @typeId, @isNullable
	END
